...
void		ft_nbr(intmax_t n, t_flags *flags)
{
...
static	int	ft_elsupp(t_flags *flags, int i, intmax_t n, int preci)
{
	if (flags->preci == -1)
	{
		ft_nbr(n, flags);
...
static	int	ft_suppd(t_flags *flags, int i, int size, intmax_t n)
{
	int	preci;
